...
import panar from "@/assets/img.png"
    ...
    return (
        <section className="capitalize flex flex-col items-center gap-10">
            <div className="min-w-full h-screen relative">
                <div className=" flex flex-col items-center justify-center w-full h-full bg-black bg-opacity-35 text-white absolute z-0">
                    <p className="text-primary-foreground text-base uppercase font-semibold">Read</p>
            ...
            <div className="w-3/4 h-auto grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col justify-center">
                    <p className="text-primary-foreground text-sm uppercase font-semibold">Promotion</p>
                    <h3 className="text-4xl font-semibold my-3">We Provide You Best  Sightseeing Tours</h3>
                    <p>
            ...
            <div className="relative">
                <Image className="object-cover" src={panar} alt="Wanderlust" />
                <span className="text-2xl md:text-5xl font-semibold absolute top-1/2 left-1/2 text-white transform -translate-x-1/2 -translate-y-1/2 z-10 ">
                    Wanderlust
                </span>
            </div>
            ...
            <div className="w-3/4 flex justify-around gap-5 flex-col-reverse md:flex-row">
                ...
                <div className=" md:w-1/2 md:p-10 flex flex-col justify-center">
                    ...
                    <h3 className="text-4xl font-semibold my-3">Our Popular Tour Plans</h3>
                    <p>
                        Et labore harum non nobis ipsum eum molestias mollitia et corporis praesentium a laudantium internos. Non quis eius quo eligendi corrupti et fugiat nulla qui soluta recusandae in maxime quasi aut ducimus illum aut optio quibusdam!
                    </p>
            ...
            <div className="w-5/6 text-center">
                ...
                <p className="text-primary-foreground text-center text-sm uppercase font-semibold">Explore more</p>
                <h3 className="text-4xl font-semibold my-5">Our International Packages</h3>
                    ...
                    {images.map((item, index) => (
                        <div key={index} className="relative w-full">
                            <div className="absolute w-full h-full bg-black bg-opacity-20">
                                <h1 className="absolute bottom-5 left-5 text-white text-lg font-semibold">{item.place}</h1>
                            </div>
                            <Image
                                src={item.img}
                                alt={item.place}
