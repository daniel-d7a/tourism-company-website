...
export default function Booking() {
  const arr = [
    {
      icon: <LuBoxSelect className="bg-blue-900 text-white p-1 rounded" size={30} />,
      title: "Choose Destination",
      disc: "Lorem ipsum dolor sit amet, consectetur elit.Urna, tortor tempus."
    },
    {
      icon: <FaRegCalendarCheck className="bg-green-800 text-white p-1 rounded" size={30} />,
      title: "Check Availability",
      disc: "Lorem ipsum dolor sit amet, consectetur elit.Urna, tortor tempus."
    }
    ,
    {
      icon: <FaCarSide className="bg-orange-800 text-white p-1 rounded" size={30} />,
      title: "Let's Go",
      disc: "Lorem ipsum dolor sit amet, consectetur elit.Urna, tortor tempus."
    }]
  return (
