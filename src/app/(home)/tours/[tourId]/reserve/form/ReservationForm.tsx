...
import { ReserveForm } from "./Reservation.hooks";
...
export default function ReservationForm({ tourOptions, tourPrice }: { tourOptions?: TourOption[], tourPrice: number }) {
    const { reserveForm, onSubmit, isDirty, isSubmitting, isValid, errors } = ReserveForm()
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input required placeholder="Enter your Hotel Name" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                                            ...
                                            <FormControl>
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={(checked) => {
                                                        let result = checked
                                                            ? field.onChange([...field.value as TourOption[], item])
                                                            : field.onChange(
