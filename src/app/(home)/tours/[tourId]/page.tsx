...
export default async function TourPage({ params: { tourId } }: { params: { tourId: string } }) {
    ...
    <>
      <div className="md:px-24 md:pt-32 pt-24 px-10 grid md:grid-cols-2 md:gap-3">
                ...
                <CarouselContent>
                  {media?.map((item, index) => (
                    <CarouselItem key={index}>
                      ...
                      />
                      <p className="text-center text-base text-gray-600 my-1">Slide  of {index+1} of {media.length}</p>
                    </CarouselItem>
                  ))
                  }
                </CarouselContent>
        ...
        <div className="md:px-10 flex-col justify-between capitalize">
          <div className="space-y-4" >
            ...
            <h3 className="text-2xl font-medium"> Duration : <span className="font-normal"> {duration}</span></h3>
            <h3 className="text-2xl font-medium">price : <span className="font-normal"> {price}</span> $</h3>
          </div>
      ...
      <div className="mt-5 md:px-24 px-8 font-lato capitalize">
        <h3 className="text-3xl font-serif my-3 py-3 border-b-2">overview</h3>
        {
          !includes.length ? "" :
            <>
              <h3 className="mt-5 text-2xl bg-gray-300 font-medium rounded-md p-1 flex items-center"> <FaCheckCircle color="green" className="mx-2" /> Include</h3>
        ...
        }
        {
          !excludes.length ? "" :
            <>
              <h3 className="mt-5 text-2xl bg-gray-300 font-medium rounded-md p-1 flex items-center"> <MdCancel className="text-red-700 mx-2" />Exclude</h3>
              <ul className="mx-10 my-1 text-xl">
        ...
        }
        {
          !options.length ? "" :
            <>
              <h3 className="mt-5 text-2xl bg-gray-300 font-medium rounded-md p-1 flex items-center"><FaBed className="mx-2" /> Options</h3>
              <ul className="mx-10 my-1 text-xl">
...

        {
          !reviews.length ? "" :
            <>
              <h3 className="mt-10 text-3xl font-medium font-lato  my-3 py-3 border-b-2 col-span-2 ">Overall Reviews</h3>
                    ...
                    <div className="border-b-2  py-3" key={index}>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Image className="mx-2 inline" src={star} alt="rate" width={15} />
                        </div>
                      </div>
