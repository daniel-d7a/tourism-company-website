...
export default function TourPage({ params }: { params: param }) {
    ...
    return (
        <>
            <div className="md:px-24 md:pt-32 pt-40 px-10 flex justify-between grid md:grid-cols-2 gap-5">
                <div className="w-full flex justify-center items-baseline">
                    <Carousel className="w-4/5 md:w-full">
                        ...
                        <CarouselContent>
                            {
                                tourTemplate.src.map((item, index) => <CarouselItem key={index}>
                ...
                <div className="md:px-10 capitalize">
                    <h2 className="tracking-widest font-medium text-gray-400 mb-1">{tourTemplate.location}</h2>
                    <h1 className="text-3xl font-medium">{tourTemplate.name}</h1>
                    <p className="text-base">{tourTemplate.description}</p>
                    <h3 className="text-xl font-bold my-2">Duration : {tourTemplate.duration}</h3>
                    ...
                    <h3 className="text-2xl font-bold my-2">price : {tourTemplate.price}</h3>
                </div>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <div className="flex items-center">
                            <span className="text-3xl font-bold">{tourTemplate.overallRate}</span>
