...
export default function StrongPointsSection() {
    ...
    let info: FeatureInfo[] = [
        {
            src: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="icon">
    ...
    return (
        <section className="mt-5 md:p-20 p-5">
            <h3 className="title text-center">Make Your Reservation with Assurance</h3>
            <div className="grid md:grid-cols-3 gap-5 m-10">
                {
                    info.map((item, index) => <FeatureCard key={index} params={item} />)
                }
            </div>
