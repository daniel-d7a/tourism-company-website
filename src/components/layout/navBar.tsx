    ...
    return (
        <header className={header ? "w-screen text-black bg-white shadow-md fixed z-50" : " w-screen py-3 text-white bg-transparent fixed z-50"} >
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <Link href='/' className={header ? "flex title-font font-medium items-center text-gray-800 mb-4 md:mb-0" : "flex title-font font-medium items-center text-white mb-4 md:mb-0"}>
                ...
                <nav className="md:ml-auto flex flex-wrap items-center text-xl justify-center">
                    ...
                    <Link href="/tours" className="navItem">Tours</Link>
